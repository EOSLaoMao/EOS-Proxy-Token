(module
 ...
 (data (i32.const 32) "bankofstaked\00")
 (data (i32.const 64) "active\00")
 (data (i32.const 80) "write\00")
 (data (i32.const 96) " \00")
 (data (i32.const 100) "\02\00\00\00\03\00\00\00")
 (data (i32.const 112) "T = \00")
 (data (i32.const 128) "static const char *boost::detail::ctti<boost::algorithm::detail::token_finderF<boost::algorithm::detail::is_any_ofF<char> > >::n() [T = boost::algorithm::detail::token_finderF<boost::algorithm::detail::is_any_ofF<char> >]\00")
